...
/**
[self setBackgroundColor: [UIColor colorFromHexString:realDockHex]];



[self setBackgroundColor:[UIColor colorFromHexString:kDockColorHex alpha:YES]];
**/
