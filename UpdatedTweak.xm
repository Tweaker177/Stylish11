...
static double r1 = arc4random_uniform(255);
static double g1 = arc4random_uniform(255);
static double b1 = arc4random_uniform(255);
...
if((kWantsClearHighlights) || (kWantsRandomHighlights)) {
arg1= TRUE;
return %orig;
}
return %orig;
...
if((kWantsRandomHighlights) || (kWantsClearHighlights))
 {
...
else if(kScreenshotsDisabled || (GetPrefBool(@"key24"))) {
arg1= nil; 
return %orig(arg1,arg2);
}
return %orig;
...
kSlidersEnabled = [[prefs objectForKey:@"SlidersEnabled"] doubleValue];
...
kHideDotsAndX = [prefs boolForKey:@"hideDotsAndX"]; //key6

kScreenshotsDisabled = [prefs boolForKey:@"screenshotsDisabled"]; //key23

kSquareIcons =  [prefs boolForKey:@"squareIcons"]; //key11

kCircularFolders =  [prefs boolForKey:@"circularFolders"]; //key17
